    ...
    : WContainerWidget()
{
    ...
    {
    case Wt::Side::Left:
        legendSide_->setCurrentIndex(0);
        break;
    case Wt::Side::Right:
        legendSide_->setCurrentIndex(1);
        break;
    case Wt::Side::Top:
        legendSide_->setCurrentIndex(2);
        break;
    case Wt::Side::Bottom:
        legendSide_->setCurrentIndex(3);
        break;
    default:
        break;
    }
    ...
    case Wt::AlignmentFlag::Left:
        legendAlignment_->setCurrentIndex(0);
        break;
    case Wt::AlignmentFlag::Center:
        legendAlignment_->setCurrentIndex(1);
        break;
    case Wt::AlignmentFlag::Right:
        legendAlignment_->setCurrentIndex(2);
        break;
    case Wt::AlignmentFlag::Top:
        legendAlignment_->setCurrentIndex(3);
        break;
    case Wt::AlignmentFlag::Middle:
        legendAlignment_->setCurrentIndex(4);
        break;
    case Wt::AlignmentFlag::Bottom:
        legendAlignment_->setCurrentIndex(5);
        break;
    default:
        break;
    }
    ...
    {
        xMin_->setEnabled(true);
        xMax_->setEnabled(true);
    ...
    {
        yMin_->setEnabled(true);
        yMax_->setEnabled(true);
    ...
    {
        zMin_->setEnabled(true);
        zMax_->setEnabled(true);
    ...
    const auto changeIntersectionLinesColor = [=]()
    {
        ...
        {
        case 0:
            chart->setIntersectionLinesColor(Wt::WColor(255,0,0));
            break;
        case 1:
            chart->setIntersectionLinesColor(Wt::WColor(0,255,0));
            break;
        case 2:
            chart->setIntersectionLinesColor(Wt::WColor(0,0,255));
            break;
        case 3:
            chart->setIntersectionLinesColor(Wt::WColor(0,0,0));
            break;
        case 4:
            chart->setIntersectionLinesColor(Wt::WColor(0,255,255));
            break;
        case 5:
            chart->setIntersectionLinesColor(Wt::WColor(255,0,255));
            break;
        case 6:
            chart->setIntersectionLinesColor(Wt::WColor(255,255,0));
            break;
        }
    };
    ...
    legendSide_->changed().connect([=]()
    {
        ...
        {
        case 0:
            chart->setLegendLocation(Wt::Side::Left, chart->legendAlignment());
            break;
        case 1:
            chart->setLegendLocation(Wt::Side::Right, chart->legendAlignment());
            break;
        case 2:
            chart->setLegendLocation(Wt::Side::Top, chart->legendAlignment());
            break;
        case 3:
            chart->setLegendLocation(Wt::Side::Bottom, chart->legendAlignment());
            break;
        }
    });
    legendAlignment_->changed().connect([=]()
    {
        ...
        {
        case 0:
            chart->setLegendLocation(chart->legendSide(), Wt::AlignmentFlag::Left);
            break;
        case 1:
            chart->setLegendLocation(chart->legendSide(), Wt::AlignmentFlag::Center);
            break;
        case 2:
            chart->setLegendLocation(chart->legendSide(), Wt::AlignmentFlag::Right);
            break;
        case 3:
            chart->setLegendLocation(chart->legendSide(), Wt::AlignmentFlag::Top);
            break;
        case 4:
            chart->setLegendLocation(chart->legendSide(), Wt::AlignmentFlag::Middle);
            break;
        case 5:
            chart->setLegendLocation(chart->legendSide(), Wt::AlignmentFlag::Bottom);
            break;
        }
    });
