      ...
      gridData_(0)
{
    ...
    penColor_->changed().connect([&]()
    {
        ...
        {
        case 0:
            pen.setColor(Wt::WColor(Wt::StandardColor::Black));
            break;
        case 1:
            pen.setColor(Wt::WColor(Wt::StandardColor::Red));
            break;
        case 2:
            pen.setColor(Wt::WColor(Wt::StandardColor::Green));
            break;
        case 3:
            pen.setColor(Wt::WColor(Wt::StandardColor::Blue));
            break;
        }
        gridData_->setPen(pen);
    });
    clippingLinesColor_->changed().connect([&]()
    {
        ...
        {
        case 0:
            gridData_->setClippingLinesColor(Wt::WColor(Wt::StandardColor::Black));
            break;
        case 1:
            gridData_->setClippingLinesColor(Wt::WColor(Wt::StandardColor::Red));
            break;
        case 2:
            gridData_->setClippingLinesColor(Wt::WColor(Wt::StandardColor::Green));
            break;
        case 3:
            gridData_->setClippingLinesColor(Wt::WColor(Wt::StandardColor::Blue));
            break;
        case 4:
            gridData_->setClippingLinesColor(Wt::WColor(Wt::StandardColor::Cyan));
            break;
        case 5:
            gridData_->setClippingLinesColor(Wt::WColor(Wt::StandardColor::Magenta));
            break;
        case 6:
            gridData_->setClippingLinesColor(Wt::WColor(Wt::StandardColor::Yellow));
            break;
        }
    });
