...
void ChartConfig::update()
{
    ...
    if(haveLegend)
    {
        ...
        {
        case 0:
            location = LegendLocation::Outside;
            break;
        case 1:
            location = LegendLocation::Inside;
            break;
        }
        ...
        case 1:
            ...
            break;
        case 2:
            alignment = AlignmentFlag::Right;
            break;
        case 3:
            alignment = AlignmentFlag::Top;
            break;
        case 4:
            alignment = AlignmentFlag::Middle;
            break;
        case 5:
            alignment = AlignmentFlag::Bottom;
            break;
        }
