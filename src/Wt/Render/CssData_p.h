    ...
    namespace Render
    {
        ...
        struct SimpleSelectorImpl final : public SimpleSelector
        {
            public:
                ...
                virtual DomElementType elementType() const override
                {
                    return elementType_;
                }
                virtual const std::string & hashId()      const override
                {
                    return hashid_;
                }
                virtual const std::vector<std::string> & classes() const override
                {
                    return classes_;
                }
        ...
        class SelectorImpl final : public Selector
        {
            public:
                ...
                {
                    return simpleSelectors_.size();
                }
                virtual const SimpleSelector & at(int i) const override
                {
                    return simpleSelectors_[i];
                }
        ...
        class RulesetImpl : public Ruleset
        {
            public:
                RulesetImpl() { }
                virtual const Selector     &    selector() const override
                {
                    return selector_;
                }
                virtual const DeclarationBlock & declarationBlock() const override
                {
                    return block_;
                }

                void setBlock(const DeclarationBlockImpl & b)
                {
                    block_ = b;
                }
        ...
        class StyleSheetImpl : public StyleSheet
        {
            public:
                ...
                {
                    return rulesetArray_.size();
                }
                virtual const Ruleset & rulesetAt(int i) const override
                {
                    return rulesetArray_[i];
                }
