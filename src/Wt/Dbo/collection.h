    ...
    namespace Dbo
    {
        ...
        class collection
        {
            ...
            public:
                ...
                const std::vector<C> & manualModeInsertions() const
                {
                    return manualModeInsertions_;
                }
                std::vector<C> & manualModeInsertions()
                {
                    return manualModeInsertions_;
                }
                const std::vector<C> & manualModeRemovals() const
                {
                    return manualModeRemovals_;
                }
                std::vector<C> & manualModeRemovals()
                {
                    return manualModeRemovals_;
                }
            ...
            private:
                ...
                {
                    return data_.relation.activity;
                }
                void resetActivity();
                void releaseQuery();
