...
namespace IBPP
{
    ...
    class Date
    {
        ...
        public:
            ...
            bool operator==(const Date & rv) const
            {
    ...
    class Time
    {
        ...
        public:
            ...
            bool operator==(const Time & rv) const
            {
                return mTime == rv.GetTime();
            }
            bool operator!=(const Time & rv) const
            {
                return mTime != rv.GetTime();
