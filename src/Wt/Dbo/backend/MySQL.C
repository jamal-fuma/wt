            ...
            class MySQLStatement final : public SqlStatement
            {
                ...
                private:
                    ...
                    void free_outpars()
                    {
                        ...
                        {
                            if(out_pars_[i].buffer != nullptr)
                            {
                                free(out_pars_[i].buffer);
                            }
                            if(out_pars_[i].is_null != nullptr)
                            {
                                free(out_pars_[i].is_null) ;
                            }
                            if(out_pars_[i].length != nullptr)
                            {
                                free(out_pars_[i].length);
                            }
                            if(out_pars_[i].error != nullptr)
                            {
                                free(out_pars_[i].error);
                            }
                        }
                        free(out_pars_);
                        out_pars_ = nullptr;
