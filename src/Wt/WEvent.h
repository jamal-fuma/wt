...
namespace Wt
{
    ...
    class WT_API Touch
    {
        public:
            ...
            {
                return Coordinates(documentX_, documentY_);
            }
            ...
            {
                return Coordinates(clientX_, clientY_);
            }
            ...
            {
                return Coordinates(screenX_, screenY_);
            }
            ...
            {
                return Coordinates(widgetX_, widgetY_);
            }
    ...
    class WT_API WDropEvent
    {
        public:
            ...
            {
                return mouseEvent_ ? OriginalEventType::Mouse : OriginalEventType::Touch;
            }
