...
namespace Wt
{
    ...
    class WTreeViewNode : public WContainerWidget
    {
        public:
            ...
            const WModelIndex & modelIndex() const
            {
                return index_;
            }
            int childrenHeight() const
            {
                return childrenHeight_;
            }
            int renderedHeight();
            bool childrenLoaded() const
            {
                return childrenLoaded_;
            }
            ...
            WTreeViewNode * parentNode() const
            {
                return parentNode_;
            }
    ...
    void WTreeView::adjustToViewport(WTreeViewNode * changed)
    {
        ...
        if(renderMore)
        {
            ...
            else if(newFirstRenderedRow < firstRenderedRow_
        ...
        if(app->environment().ajax())
        {
            if(viewportHeight_ != UNKNOWN_VIEWPORT_HEIGHT)
            {
                ...
                case ScrollHint::PositionAtBottom:
                    viewportTop_ = row - viewportHeight_ + 1;
                    break;
                case ScrollHint::PositionAtCenter:
                    viewportTop_ = row - viewportHeight_/2 + 1;
                    break;
                default:
                    break;
                }
