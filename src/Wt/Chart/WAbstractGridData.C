    ...
    namespace Chart
    {
                ...
                int Nx, int Ny, int size)
        {
            ...
            case Series3DType::Bar:
                ...
                {
                    int index = i*8;
                    indicesOUT.push_back(index+0);
                    indicesOUT.push_back(index+1);
                    indicesOUT.push_back(index+1);
                    indicesOUT.push_back(index+2);
                    indicesOUT.push_back(index+2);
                    indicesOUT.push_back(index+3);
                    indicesOUT.push_back(index+3);
                    indicesOUT.push_back(index+0);
                    indicesOUT.push_back(index+4);
                    indicesOUT.push_back(index+5);
                    indicesOUT.push_back(index+5);
                    indicesOUT.push_back(index+6);
                    indicesOUT.push_back(index+6);
                    indicesOUT.push_back(index+7);
                    indicesOUT.push_back(index+7);
                    indicesOUT.push_back(index+4);
                    indicesOUT.push_back(index+0);
                    indicesOUT.push_back(index+4);
