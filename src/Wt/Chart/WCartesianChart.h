    ...
    namespace Chart
    {
        ...
        class WT_API WCartesianChart : public WAbstractChart
        {
            ...
            public:
                ...
                {
                    return legend_.isLegendEnabled();
                }
                ...
                {
                    return legend_.legendAlignment();
                }
                ...
                {
                    return legend_.legendColumnWidth();
                }
                ...
                {
                    return legend_.legendBackground();
                }
                ...
                {
                    return seriesSelectionEnabled_;
                }
                ...
                {
                    return curveManipulationEnabled_;
                }
                ...
                {
                    return onDemandLoadingEnabled_;
                }
