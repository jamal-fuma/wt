...
namespace Wt
{
    namespace Chart
    {
        ...
        {
            XYGridEnabled_[0] = false;
            XYGridEnabled_[1] = false;
            XZGridEnabled_[0] = false;
            XZGridEnabled_[1] = false;
            YZGridEnabled_[0] = false;
            YZGridEnabled_[1] = false;
        ...
        void WCartesian3DChart::deleteAllGLResources()
        {
            ...
            deleteGLTextures();
            deleteBuffer(cubeTexCoords_);
            cubeTexCoords_.clear();
            deleteBuffer(axisTexCoordsHoriz_);
            axisTexCoordsHoriz_.clear();
            deleteBuffer(axisTexCoordsVert_);
            axisTexCoordsVert_.clear();
            ...
            deleteProgram(cubeProgram_);
            cubeProgram_.clear();
            deleteProgram(axisProgram_);
            axisProgram_.clear();
            deleteProgram(cubeLineProgram_);
            cubeLineProgram_.clear();
        ...
        void WCartesian3DChart::deleteGLTextures()
        {
            ...
            deleteTexture(horizAxisTexture_);
            horizAxisTexture_.clear();
            deleteTexture(horizAxisTexture2_);
            horizAxisTexture2_.clear();
            deleteTexture(vertAxisTexture_);
            vertAxisTexture_.clear();
            deleteTexture(cubeTextureXY_);
            cubeTextureXY_.clear();
            deleteTexture(cubeTextureXZ_);
            cubeTextureXZ_.clear();
            deleteTexture(cubeTextureYZ_);
            cubeTextureYZ_.clear();
            if(!titleTexture_.isNull())
            {
