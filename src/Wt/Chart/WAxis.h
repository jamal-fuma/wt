    ...
    namespace Chart
    {
        ...
        class WT_API WAxis
        {
            public:
                ...
                double segmentMargin() const
                {
                    return segmentMargin_;
                }
            ...
            public:
                ...
                void setRenderMirror(bool enable)
                {
                    renderingMirror_ = enable;
                }
