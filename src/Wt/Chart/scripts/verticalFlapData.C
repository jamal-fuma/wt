...
int main()
{
    ...
    inPlaneBools[0][0] = 1.0;
    inPlaneBools[0][1] = 0.0;
    inPlaneBools[0][2] = 1.0;
    inPlaneBools[0][3] = 0.0;
    ...
    inPlaneBools[1][0] = 1.0;
    inPlaneBools[1][1] = 0.0;
    inPlaneBools[1][2] = 1.0;
    inPlaneBools[1][3] = 0.0;
    ...
    inPlaneBools[2][0] = 1.0;
    inPlaneBools[2][1] = 0.0;
    inPlaneBools[2][2] = 1.0;
    inPlaneBools[2][3] = 0.0;
    ...
    inPlaneBools[3][0] = 1.0;
    inPlaneBools[3][1] = 0.0;
    inPlaneBools[3][2] = 1.0;
    inPlaneBools[3][3] = 0.0;
    writeAll();
