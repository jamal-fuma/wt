...
namespace
{
    ...
    struct CExpressionParser : grammar<CExpressionParser>
    {
        ...
        private:
            ...
            void eq_op(::int64_t & x, ::int64_t y) const
            {
                x = x == y;
            }
            void neq_op(::int64_t & x, ::int64_t y) const
            {
                x = x != y;
            }

            void lt_op(::int64_t & x, ::int64_t y) const
            {
                x = x < y;
            }
            void gt_op(::int64_t & x, ::int64_t y) const
            {
                x = x > y;
            }
            void lte_op(::int64_t & x, ::int64_t y) const
            {
                x = x <= y;
            }
            void gte_op(::int64_t & x, ::int64_t y) const
            {
                x = x >= y;
            }
            ...
            void or_op(::int64_t & x, ::int64_t y) const
            {
                x = x || y;
            }
            void and_op(::int64_t & x, ::int64_t y) const
            {
                x = x && y;
            }

            void set_result(int result) const
            {
                result_ = result;
            }
        private :
