    ...
    */
    ...
    class WT_API WApplication : public WObject
    {
        public:
            ...
            {
                return internalPathDefaultValid_;
            }
             ...
             * in widgetset mode.
             */
            WContainerWidget * domRoot2() const
            {
                return domRoot2_.get();
            }
        ...
        private:
            ...
            WContainerWidget * timerRoot() const
            {
                return timerRoot_;
            }
            ...
            SignalMap & exposedSignals()
            {
                return exposedSignals_;
            }
            std::set<std::string> & justRemovedSignals()
            {
                return justRemovedSignals_;
            }
             ...
             */
            void setExposeSignals(bool how)
            {
                exposeSignals_ = how;
            }
            bool exposeSignals() const
            {
                return exposeSignals_;
            }
            void doUnload();
