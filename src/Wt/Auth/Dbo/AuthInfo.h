        ...
        namespace Dbo
        {
            ...
            class AuthIdentity : public Wt::Dbo::Dbo< AuthIdentity<AuthInfoType> >
            {
                public:
                    ...
                    void setIdentity(const Wt::WString & identity)
                    {
                        identity_ = identity;
                    }
