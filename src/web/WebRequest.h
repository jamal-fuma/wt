...
namespace Wt
{
    ...
    class WT_API WebRequest
    {
        public:
            ...
            {
                return webSocketRequest_;
            }
            void setWebSocketRequest(bool ws)
            {
                webSocketRequest_ = ws;
            }
            ...
            const Http::UploadedFileMap & uploadedFiles() const
            {
                return files_;
            }
            ::int64_t postDataExceeded() const
            {
                return postDataExceeded_;
            }
