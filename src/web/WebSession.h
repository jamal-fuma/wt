...
namespace Wt
{
...
#endif
    {
        public:
            ...
            std::string multiSessionId() const
            {
                return multiSessionId_;
            }
            void setMultiSessionId(const std::string & multiSessionId);

            WebController * controller() const
            {
                return controller_;
            }
            WEnvironment & env()
            ...
            {
                return deploymentPath_;
            }

            bool hasSessionIdInUrl() const
            {
                return sessionIdInUrl_;
            }
            void setSessionIdInUrl(bool value)
            {
                sessionIdInUrl_ = value;
            }
            bool useUglyInternalPaths() const;
            void setPagePathInfo(const std::string & path);
            std::string pagePathInfo() const
            {
                return pagePathInfo_;
            }
